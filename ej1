...
int main() {
    ...
    do {
        cout << "Ingrese N�mero de alumnos: ";
        cin >> n;
    } while ( n <= 0 || n > 20);
    ...
    // 1. Implementar la funci�n GenerayLista_Paralelos, que permita generar de forma aleatoria e 
    ...
    // 2. Implementar la funci�n Porcentaje_gripe_tos, que determine el porcentaje de alumnos que
    //    tuvieron gripe y tos simult�neamente sobre el total de alumnos.
    double porcentaje = porcentajeGripeTos(gripe, tos, n);
    cout << "\nPorcentaje de alumnos(as) que tienen gripe y tos: "<<porcentaje<<"%"<<endl;

    // 3. TODO: Implementar la funci�n Promedio_pesos, que determine el promedio del peso de los alumnos
    //    que han tenido alguna enfermedad.
    
    // 4. Implementar la funci�n Listado_ordenado, que imprima el listado de los alumnos ordenado
