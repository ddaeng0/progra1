...
int main() {
    ...
    // 1. Ingreso del n�mero de personas
    do {
        cout << "Ingresar el n�mero de encuestados: ";
        cin >> n;
    } while (n <= 0 || n > 100);
    ...
    // 3. Calcule e imprima cual es el nivel de aprobaci�n que obtuvo la mayor votaci�n
    ...
    // 4. Calcule e imprima cuantas personas del nivel socio econ�mico A, participaron de la encuesta
    ...
    // 5. TODO: Determine e imprima la edad de la persona m�s joven que fue encuestada.
